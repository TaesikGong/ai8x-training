...
class AI85EfficientNetV2_Custom(nn.Module):
    """
    ...
    def __init__(
        ...
        self.mb_conv9 = ai8x_blocks.MBConvBlock(128, 128, 3, bias=bias, se_ratio=None,
                                                expand_ratio=4, fused=False, **kwargs)
        # Head Layer
        self.conv_head = ai8x.FusedConv2dBNReLU(128, 512, 1, stride=1, batchnorm='Affine',
...
def ai85effnetv2_custom(pretrained=False, **kwargs):
    """
    Constructs EfficientNet v2 model.
    """
    assert not pretrained
    return AI85EfficientNetV2_Custom(**kwargs)


models = [
    {
        'name': 'ai85effnetv2_custom',
        'min_input': 1,
        'dim': 2,
    },
]
