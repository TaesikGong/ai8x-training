...
class AI85MobileNetV2_Custom(nn.Module):
    """
...
def ai85netmobilenetv2_custom(pretrained=False, **kwargs):
    """
    ...
    return AI85MobileNetV2_Custom(pre_layer_stride=2, bottleneck_settings=bottleneck_settings,
                           last_layer_width=1280, avg_pool_size=7, dimensions=(224, 244), **kwargs)


def ai85netmobilenetv2cifar100_custom(pretrained=False, **kwargs):
    """
    ...
    return AI85MobileNetV2_Custom(pre_layer_stride=1, bottleneck_settings=bottleneck_settings,
                           last_layer_width=1024, avg_pool_size=4, depthwise_bias=False, **kwargs)


def ai85netmobilenetv2cifar100_m0_75_custom(pretrained=False, **kwargs):
    """
    Constructs a MobileNet v2 model for Cifar-100 dataset optimized for AI87.
    """
    assert not pretrained
    ...
    return AI85MobileNetV2_Custom(pre_layer_stride=1, bottleneck_settings=bottleneck_settings,
                           last_layer_width=480, avg_pool_size=4, depthwise_bias=False, **kwargs)


def ai85netmobilenetv2cifar100_m0_5_custom(pretrained=False, **kwargs):
    """
    Constructs a MobileNet v2 model for Cifar-100 dataset optimized for AI87.
    """
    assert not pretrained
...
models = [
    {
        'name': 'ai85netmobilenetv2_custom',
        'min_input': 1,
        'dim': 2,
    },
    {
        'name': 'ai85netmobilenetv2cifar100_custom',
        'min_input': 1,
        'dim': 2,
    },
    {
        'name': 'ai85netmobilenetv2cifar100_m0_75_custom',
        'min_input': 1,
        'dim': 2,
    },
    {
        'name': 'ai85netmobilenetv2cifar100_m0_5_custom',
        'min_input': 1,
        'dim': 2,
    },
]
